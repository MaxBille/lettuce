...
parser.add_argument("--obs_interval_PU", default=0.04, type=float, help="reporter-interval in PU-time")
...
if args["logVRAM"]:
    reporter_interval_LU = 1
else:
    reporter_interval_LU = int(n_steps*args["obs_interval_PU"]/T_target)
...
if calculate_force_coefficients:
    ...
    Dragreport = lt.ObservableReporter(DragObservable, interval=reporter_interval_LU, out=None)  # create reporter and link to created observable
    ...
    Liftreport = lt.ObservableReporter(LiftObservable, interval=reporter_interval_LU, out=None)
...
# NaN STOP
if nan_reporter:
    NaNReporter = lt.NaNReporter(flow, lattice, n_steps, T_target, interval=1000)
