...
plt.setp(lines[0], ls="", lw=1, marker=">", color="tab:green")
plt.setp(lines[1], ls="", lw=1, marker="<", color="tab:blue")
plt.setp(lines[2], ls="", lw=1, marker="o", color="tab:orange")
...
plt.savefig(folder+"/plots/St_Literature_v02.png")
plt.show()
