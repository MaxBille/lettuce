...
matplotlib.rcParams.update({'lines.markeredgewidth': 1.2, 'lines.markersize': 3})
...
plt.setp(lines[0], ls="", lw=1, marker="+", color="tab:red")
plt.setp(lines[1], ls="", lw=1, marker="x", color="tab:purple")
plt.setp(lines[2], ls="", lw=1, marker=">", color="tab:green")
plt.setp(lines[3], ls="", lw=1, marker="<", color="tab:blue")
plt.setp(lines[4], ls="", lw=1, marker="o", color="tab:orange")
...
plt.savefig(folder+"/plots/Cd_Literature_v02.png")
plt.show()
