...
matplotlib.rcParams.update({'font.size': 11}) # font size was 11
...
plt.setp(lines, ls="", lw=1, marker="+", color="tab:pink", label="Williamson 1988 [num.]")
...
plt.setp(lines, ls="", lw=1, marker="+", color="tab:blue", label="sonstige num. Literatur")
