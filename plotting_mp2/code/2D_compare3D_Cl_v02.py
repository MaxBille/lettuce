...
hwbb_bgk_2d = plt.plot(data2d[0], data2d[1], marker=".", color="tab:orange", label="2D HWBB")
ibb_bgk_2d = plt.plot(data2d[0], data2d[2], marker=".", color="tab:green", label="2D IBB")

hwbb_bgk_3d = plt.plot(data3d[0], data3d[1], marker="x", color="tab:orange", label="3D HWBB")
ibb_bgk_3d = plt.plot(data3d[0], data3d[2], marker="x", color="tab:green", label="3D IBB")
